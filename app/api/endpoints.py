...
class OfferEndpoints:
    ...
    async def create_offer_request(
        ...
        try:
            # Process slices to ensure proper format
            processed_slices = []
            for slice_data in slices:
                # Create a properly formatted slice according to Duffel API requirements
                processed_slice = {
                ...
                # Only include optional fields if they're relevant to Duffel's API
                # Remove departure_time and arrival_time which aren't part of Duffel's API
